import maSource from './components/ma-source.vue'

const containers = {
  full: () => import('./components/ma-container-full.vue'),
  fullbs: () => import('./components/ma-container-full-bs.vue'),
  ghost: () => import('./components/ma-container-ghost.vue'),
  ghostbs: () => import('./components/ma-container-ghost-bs.vue'),
  card: () => import('./components/ma-container-card.vue'),
  cardbs: () => import('./components/ma-container-card-bs.vue')
}

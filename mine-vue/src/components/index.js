...
Vue.component('ma-markdown', () => import('./ma-markdown'))
Vue.component('ma-mde', () => import('./ma-mde'))
...
Vue.component('ma-quill', () => import('./ma-quill'))
Vue.component('ma-scrollbar', () => import('./ma-scrollbar'))
Vue.component('ma-ueditor', () => import('./ma-ueditor'))

    ...
    <el-row :gutter="20">
      <el-col :span="12">
        ...
        <el-table v-loading="loading" :data="dataList" row-key="id" @selection-change="handleSelectionChange">
          <el-table-column prop="name" label="名称" fixed width="240" :show-overflow-tooltip="true"></el-table-column>
      ...
      <el-col :span="12">
        ...
        <el-card class="box-card ma-card" shadow="hover">
          <div slot="header" class="clearfix">
            <span>{{ isEdit ? '修改修改' : '新增配置' }}</span>
          </div>
          <el-form ref="form" :model="form" :rules="rules" label-width="40px">
            <el-form-item label="名称" prop="name">
              <el-input v-model="form.name" size="small" placeholder="请输入配置名称"></el-input>
            </el-form-item>
            <el-form-item label="值" prop="value">
              <el-input v-model="form.value" size="small" placeholder="请输入值"></el-input>
            </el-form-item>
          </el-form>
            <el-button type="primary" class="right" @click="submitForm" size="small">确 定</el-button>
        </el-card>
      </el-col>
    </el-row>

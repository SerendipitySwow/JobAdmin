          ...
          <el-row :gutter="10">
            <el-col :span="1.5">
              ...
              <el-button
                size="small"
                icon="el-icon-plus"
                v-hasPermission="['system:dictType:save']"
                @click="$refs.typeForm.create()"
              >新增</el-button>

              <el-button
                size="small"
                icon="el-icon-delete"
                :disabled="typeBtnIsDisabed"
                v-hasPermission="['system:dictType:delete']"
                @click="handleDeletes('type')"
              >删除</el-button>

            </el-col>

            <table-right-toolbar
              recycleCode="system:dictType:recycle"
              @toggleData="switchTypeList"
              @refreshTable="getTypeList"
              @toggleSearch="switchShowTypeSearch"
            ></table-right-toolbar>
            ...
            <el-table-column label="操作" align="center">
              <template slot-scope="scope">
                ...
                <div v-if="showTypeRecycle">
                  ...
                  <el-button
                    type="text"
                    v-hasPermission="['system:dictType:recovery']"
                    @click="handleRecovery(scope.row.id, 'type')"
                  >恢复</el-button>

                  <el-button
                    type="text"
                    v-hasPermission="['system:dictType:realDelete']"
                    @click="handleRealDelete(scope.row.id, 'type')"
                  >删除</el-button>
                ...
                <div v-else>
                  ...
                  <el-button
                    type="text"
                    v-hasPermission="['system:dictType:update']"
                    @click="$refs.typeForm.update(scope.row)"
                  >修改</el-button>

                  <el-button
                    type="text"
                    v-hasPermission="['system:dictType:delete']"
                    @click="handleDelete(scope.row.id, 'type')"
                  >移到回收站</el-button>
      ...
      <el-col :span="12">
        ...
        <el-card class="box-card ma-card" shadow="hover">
          ...
          <el-row :gutter="10">
            <el-col :span="1.5">
              ...
              <el-button
                ...
                v-hasPermission="['system:dictData:save']"
                @click="$refs.dataForm.create(record)"
              >新增</el-button>

              <el-button
                size="small"
                icon="el-icon-delete"
                :disabled="dataBtnIsDisabed"
                v-hasPermission="['system:dictData:delete']"
                @click="handleDeletes('data')"
              >删除</el-button>

            </el-col>

            <table-right-toolbar
              recycleCode="system:dictData:recycle"
              @toggleData="switchDataList"
              @refreshTable="getDataList"
              @toggleSearch="switchShowDataSearch"
            ></table-right-toolbar>
          ...
          <el-table
            ...
            :data="dataList"
            row-key="id"
            @selection-change="handleSelectionDataChange"
          >
            <el-table-column type="selection" width="55"></el-table-column>
            ...
            <el-table-column label="操作" align="center">
              ...
              <template slot-scope="scope">
                ...
                <div v-if="showDataRecycle">
                  ...
                  <el-button
                    type="text"
                    v-hasPermission="['system:dictData:recovery']"
                    @click="handleRecovery(scope.row.id, 'data')"
                  >恢复</el-button>

                  <el-button
                    type="text"
                    v-hasPermission="['system:dictData:realDelete']"
                    @click="handleRealDelete(scope.row.id, 'data')"
                  >删除</el-button>
                ...
                <div v-else>
                  ...
                  <el-button
                    type="text"
                    v-hasPermission="['system:dictData:update']"
                    @click="$refs.dataForm.update(scope.row)"
                  >修改</el-button>

                  <el-button
                    type="text"
                    v-hasPermission="['system:dictData:delete']"
                    @click="handleDelete(scope.row.id, 'data')"
                  >移到回收站</el-button>

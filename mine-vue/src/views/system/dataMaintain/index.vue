<template>
  <ma-container>
    ...
    <el-table v-loading="loading" :data="dataList" row-key="Name" @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="name" label="表名称" width="180"></el-table-column>
    ...
    >
        <el-table :data="columnList" stripe>
          ...
          <el-table-column prop="column_type" label="字段类型"></el-table-column>
          <el-table-column prop="column_comment" label="字段注释"></el-table-column>
        </el-table>

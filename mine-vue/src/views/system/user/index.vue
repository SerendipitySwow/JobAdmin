  ...
  <ma-container>
    ...
    <el-row :gutter="20">
      ...
      <el-col :span="4">
        ...
        <el-input placeholder="请输入部门名称" v-model="filterDept" size="small"></el-input>
        ...
        <el-tree
          ...
          style="margin-top: 10px" ref="tree"
        ></el-tree>
        ...
        <el-row :gutter="10">
          ...
          <el-col :span="1.5">
            ...
            <el-button size="small"
              icon="el-icon-plus"
              v-hasPermission="['system:user:save']"
              @click="$refs.userForm.create()"
            >新增</el-button>
          ...
          <table-right-toolbar
            recycleCode="system:user:recycle"
          ...
          <el-table-column label="操作" align="center">
            <template slot-scope="scope">
              ...
              <div v-if="showRecycle">
                ...
                <el-button type="text"
                  v-hasPermission="['system:user:recovery']"
                  @click="handleRecovery(scope.row.id)"
                >恢复</el-button>

                <el-button type="text"
                  v-hasPermission="['system:user:realDelete']"
              ...
              <div v-else>
                ...
                <el-button
                  ...
                  @click="$refs.userForm.update(scope.row)"
                >修改</el-button>
